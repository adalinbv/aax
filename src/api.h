...
char _aaxAudioFrameProcess(_aaxRingBuffer*, _frame_t*, void*, _aaxAudioFrame*, float, float, _aaxDelayed3dProps*, _aaxDelayed3dProps*, _aaxDelayed3dProps*, _aaxDelayed3dProps*, _aax2dProps*, _aax3dProps*, const _aaxDriverBackend*, void*, char, char);
