...
typedef void (*_batch_movingavg_proc)(int32_ptr, const_int32_ptr, size_t, float*, float);
typedef void (*_batch_freqfilter_proc)(int32_ptr, const_int32_ptr, size_t, float*, float, const float*);
typedef void (*_batch_movingavg_float_proc)(float32_ptr, const_float32_ptr, size_t, float*, float);
...
extern _batch_movingavg_proc _batch_movingavg;
