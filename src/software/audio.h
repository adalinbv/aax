...
char _aaxEmittersProcess(_aaxRingBuffer*, const _aaxMixerInfo*, float, float, _aaxDelayed3dProps*, _aax2dProps*, _aax3dProps*, _aaxDelayed3dProps*, _aaxDelayed3dProps*, _intBuffers*, _intBuffers*, const _aaxDriverBackend*, void*);
void _aaxEmitterPrepare3d(_aaxEmitter*, const _aaxMixerInfo*, float, float, vec4f_t*, _aaxDelayed3dProps*, _aax3dProps*, _aaxDelayed3dProps*, _aaxDelayed3dProps*);
