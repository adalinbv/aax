...
_batch_cvt_from_proc _batch_cvt24_ph = _batch_cvt24_ph_cpu;
...
_batch_cvt_from_intl_proc _batch_cvt24_ph_intl = _batch_cvt24_ph_intl_cpu;
...
_batch_cvt_to_proc _batch_cvtph_24 = _batch_cvtph_24_cpu;
...
_batch_hmadd_proc _batch_hmadd = _batch_hmadd_cpu;
