...
void
_aaxRingBufferFillNonInterleaved(_aaxRingBufferData *rbi, const void *data, unsigned blocksize, char looping)
{
...
void
_aaxRingBufferFillInterleaved(_aaxRingBufferData *rbi, const void *data, unsigned blocksize, char looping)
{
...
void
_aaxRingBufferGetDataInterleaved(_aaxRingBufferData *rbi, void* data, unsigned int samples, int tracks, float fact)
{
   _AAX_LOG(LOG_DEBUG, __FUNCTION__);
