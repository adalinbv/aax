...
void _vec3Add_vfpv2(vec3 d, vec3 v);
void _vec4Add_vfpv2(vec4 d, const vec4 v);
void _vec3Sub_vfpv2(vec3 d, vec3 v);
...
void _vec4Matrix4_vfpv2(vec4 d, const vec4 v, mtx4 m);
void _pt4Matrix4_vfpv2(vec4 d, const vec4 p, mtx4 m);
void _mtx4SetAbsolute_vfpv2(mtx4 d, char absolute);
void _mtx4MulVec4_vfpv2(vec4 d, mtx4 m, const vec4 v);
void _mtx4Mul_vfpv2(mtx4 dst, mtx4 mtx1, mtx4 mtx2);
void _mtx4dMul_vfpv2(mtx4d dst, mtx4d mtx1, mtx4d mtx2);
void _mtx4InverseSimple_vfpv2(mtx4 dst, mtx4 mtx);
void _mtx4dInverseSimple_vfpv2(mtx4d dst, mtx4d mtx);
...
void _vec3Add_vfpv3(vec3 d, vec3 v);
void _vec4Add_vfpv3(vec4 d, const vec4 v);
void _vec3Sub_vfpv3(vec3 d, vec3 v);
...
void _vec4Matrix4_vfpv3(vec4 d, const vec4 v, mtx4 m);
void _pt4Matrix4_vfpv3(vec4 d, const vec4 p, mtx4 m);
void _mtx4SetAbsolute_vfpv3(mtx4 d, char absolute);
void _mtx4MulVec4_vfpv3(vec4 d, mtx4 m, const vec4 v);
void _mtx4Mul_vfpv3(mtx4 dst, mtx4 mtx1, mtx4 mtx2);
void _mtx4dMul_vfpv3(mtx4d dst, mtx4d mtx1, mtx4d mtx2);
void _mtx4InverseSimple_vfpv3(mtx4 dst, mtx4 mtx);
void _mtx4dInverseSimple_vfpv3(mtx4d dst, mtx4d mtx);
