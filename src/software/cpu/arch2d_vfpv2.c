...
void
_batch_imul_value_vfpv2(void* data, unsigned bps, size_t num, float f)
{
   size_t i = num;
   if (num)
   {
...
# if !RB_FLOAT_DATA
static inline void
_aaxBufResampleSkip_vfpv2(int32_ptr dptr, const_int32_ptr sptr, size_t dmin, size_t dmax, float smu, float freq_factor)
{
...
_batch_resample_vfpv2(int32_ptr d, const_int32_ptr s, size_t dmin, size_t dmax, float smu, float fact)
{
   ...
   if (fact < CUBIC_TRESHOLD) {
      ...
      _aaxBufResampleSkip_vfpv2(d, s, dmin, dmax, smu, fact);
   } else {
...
# else
static inline void
_aaxBufResampleSkip_float_vfpv2(float32_ptr dptr, const_float32_ptr sptr, size_t dmin, size_t dmax, float smu, float freq_factor)
{
...
_batch_resample_float_vfpv2(float32_ptr d, const_float32_ptr s, size_t dmin, size_t dmax, float smu, float fact)
{
   ...
   if (fact < CUBIC_TRESHOLD) {
      ...
      _aaxBufResampleSkip_float_vfpv2(d, s, dmin, dmax, smu, fact);
   } else {
