...
void
_vec4Negate_vfpv3(vec4 d, const vec4 v)
{
   d[0] = -v[0];
   d[1] = -v[1];
   d[2] = -v[2];
...
void
_vec4ScalarMul_vfpv3(vec4 r, float f)
{
   r[0] *= f;
   r[1] *= f;
   r[2] *= f;
...
void
_vec3Mulvec3_vfpv3(vec3 r, const vec3 v1, const vec3 v2)
{
   r[0] = v1[0]*v2[0];
   r[1] = v1[1]*v2[1];
   r[2] = v1[2]*v2[2];
...
void
_vec4Mulvec4_vfpv3(vec4 r, const vec4 v1, const vec4 v2)
{
   r[0] = v1[0]*v2[0];
   r[1] = v1[1]*v2[1];
   r[2] = v1[2]*v2[2];
...
float
_vec3Magnitude_vfpv3(const vec3 v)
{
...
double
_vec3dMagnitude_vfpv3(const vec3d v)
{
...
float
_vec3MagnitudeSquared_vfpv3(const vec3 v)
{
   return (v[0]*v[0] + v[1]*v[1] + v[2]*v[2]);
}

float
_vec3DotProduct_vfpv3(const vec3 v1, const vec3 v2)
{
   return  (v1[0]*v2[0] + v1[1]*v2[1] + v1[2]*v2[2]);
}

double
_vec3dDotProduct_vfpv3(const vec3d v1, const vec3d v2)
{
   return  (v1[0]*v2[0] + v1[1]*v2[1] + v1[2]*v2[2]);
}

void
_vec3CrossProduct_vfpv3(vec3 d, const vec3 v1, const vec3 v2)
{
...
float
_vec3Normalize_vfpv3(vec3 d, const vec3 v)
{
   float mag = _vec3Magnitude_vfpv3(v);
   if (mag)
   {
      d[0] = v[0] / mag;
      d[1] = v[1] / mag;
...
double
_vec3dNormalize_vfpv3(vec3d d, const vec3d v)
{
...
void
_mtx4SetAbsolute_vfpv3(mtx4 d, char absolute)
{
...
void
_mtx4Translate_vfpv3(mtx4 m, float x, float y, float z)
{
   if (x || y || z)
   {
      m[3][0] += x;
...
void
_mtx4dTranslate_vfpv3(mtx4d m, double x, double y, double z)
{
   if (x || y || z)
   {
      m[3][0] += x;
...
void
_mtx4Rotate_vfpv3(mtx4 mtx, float angle_rad, float x, float y, float z)
{
   if (angle_rad)
   {
...
void
_mtx4dRotate_vfpv3(mtx4d mtx, double angle_rad, double x, double y, double z)
{
   if (angle_rad)
   {
