...
void
vec4fFill_vfpv3(void* d, const void* v)
{
   memcpy(d, v, sizeof(vec4f_t));
}

void
_vec4fCopy_vfpv3(vec4f_ptr d, const vec4f_ptr v)
{
   memcpy(d->v4, v->v4, sizeof(vec4f_t));
}

void
_vec4iCopy_vfpv3(vec4i_ptr d, const vec4i_ptr v)
{
...
void
vec3fNegate_vfpv3(vec3f_ptr d, const vec3f_ptr v)
{
   d->v3[0] = -v->v3[0];
   d->v3[1] = -v->v3[1];
   d->v3[2] = -v->v3[2];
...
void
vec4fNegate_vfpv3(vec4f_ptr d, const vec4f_ptr v)
{
   d->v4[0] = -v->v4[0];
   d->v4[1] = -v->v4[1];
   d->v4[2] = -v->v4[2];
...
void
vec4fScalarMul_vfpv3(vec4f_ptr r, float f)
{
   r->v4[0] *= f;
   r->v4[1] *= f;
   r->v4[2] *= f;
...
void
_vec3fMulvec3_vfpv3(vec3f_ptr r, const vec3f_ptr v1, const vec3f_ptr v2)
{
...
void
_vec4fMulvec4_vfpv3(vec4f_ptr r, const vec4f_ptr v1, const vec4f_ptr v2)
{
...
void
_vec4iMulvec4i_vfpv3(vec4i_ptr r, const vec4i_ptr v1, const vec4i_ptr v2)
{
   r->v4[0] = v1->v4[0]*v2->v4[0];
   r->v4[1] = v1->v4[1]*v2->v4[1];
   r->v4[2] = v1->v4[2]*v2->v4[2];
...
float
_vec3fMagnitude_vfpv3(const vec3f_ptr v)
{
...
double
_vec3dMagnitude_vfpv3(const vec3d_ptr v)
{
...
float
_vec3fMagnitudeSquared_vfpv3(const vec3f_ptr v)
{
   return (v->v3[0]*v->v3[0] + v->v3[1]*v->v3[1] + v->v3[2]*v->v3[2]);
}

float
_vec3fDotProduct_vfpv3(const vec3f_ptr v1, const vec3f_ptr v2)
{
   return  (v1->v3[0]*v2->v3[0] + v1->v3[1]*v2->v3[1] + v1->v3[2]*v2->v3[2]);
}

double
_vec3dDotProduct_vfpv3(const vec3d_ptr v1, const vec3d_ptr v2)
{
   return  (v1->v3[0]*v2->v3[0] + v1->v3[1]*v2->v3[1] + v1->v3[2]*v2->v3[2]);
}

void
_vec3fCrossProduct_vfpv3(vec3f_ptr d, const vec3f_ptr v1, const vec3f_ptr v2)
{
...
float
_vec3fNormalize_vfpv3(vec3f_ptr d, const vec3f_ptr v)
{
...
double
_vec3dNormalize_vfpv3(vec3d_ptr d, const vec3d_ptr v)
{
...
void
vec3fMatrix3_vfpv3(vec3f_ptr d, const vec3f_ptr v, const mtx3f_ptr m)
{
 ...
 */
void
_vec4fMatrix4_vfpv3(vec4f_ptr d, const vec4f_ptr v, const mtx4f_ptr m)
{
...
void
_pt4fMatrix4_vfpv3(vec4f_ptr d, const vec4f_ptr p, const mtx4f_ptr m)
{
...
void
mtx3fCopy_vfpv3(mtx3f_ptr d, const mtx3f_ptr m)
{
   memcpy(d->m3, m->m3, sizeof(mtx3f_t));
}

void
_mtx4fCopy_vfpv3(mtx4f_ptr d, const mtx4f_ptr m)
{
   memcpy(d->m4, m->m4, sizeof(mtx4f_t));
}

void
mtx4fFill_vfpv3(void* d, const void *m)
{
   memcpy(d, m, sizeof(mtx4f_t));
}

void
_mtx4dCopy_vfpv3(mtx4d_ptr d, const mtx4d_ptr m)
{
   memcpy(d->m4, m->m4, sizeof(mtx4d_t));
}

void
mtx4dFill_vfpv3(void* d, const void *m)
{
   memcpy(d, m, sizeof(mtx4d_t));
}

void
mtx4fSetAbsolute_vfpv3(mtx4f_ptr d, char absolute)
{
   d->m4[3][3] = absolute ? 1.0f : 0.0f;
}

void
mtx4fMulVec4_vfpv3(vec4f_ptr d, const mtx4f_ptr m, const vec4f_ptr v)
{
...
void
_mtx4fMul_vfpv3(mtx4f_ptr dst, const mtx4f_ptr mtx1, const mtx4f_ptr mtx2)
{
...
void
_mtx4dMul_vfpv3(mtx4d_ptr dst, const mtx4d_ptr mtx1, const mtx4d_ptr mtx2)
{
...
void
mtx4fInverseSimple_vfpv3(mtx4f_ptr dst, const mtx4f_ptr mtx)
{
   /* side */
...
void
mtx4dInverseSimple_vfpv3(mtx4d_ptr dst, const mtx4d_ptr mtx)
{
   /* side */
   dst->m4[0][0] = mtx->m4[0][0];
   dst->m4[1][0] = mtx->m4[0][1];
...
void
mtx4fTranslate_vfpv3(mtx4f_ptr m, float x, float y, float z)
{
   if (x || y || z)
   {
      m->m4[3][0] += x;
...
void
mtx4dTranslate_vfpv3(mtx4d_ptr m, double x, double y, double z)
{
   if (x || y || z)
   {
      m->m4[3][0] += x;
...
void
mtx4fRotate_vfpv3(mtx4f_ptr mtx, float angle_rad, float x, float y, float z)
{
   if (angle_rad)
   {
...
void
mtx4dRotate_vfpv3(mtx4d_ptr mtx, double angle_rad, double x, double y, double z)
{
   if (angle_rad)
   {
