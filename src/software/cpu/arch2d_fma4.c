...
_batch_fma4_float_avx(float32_ptr dst, const_float32_ptr src, size_t num, float v, float vstep)
{
   ...
   if (i)
   {
      ...
      do
      {
         ...
         ymm0 =_mm256_macc_ps(ymm0, tv,_mm256_load_ps((const float*)(dptr+0)));
         ymm1 =_mm256_macc_ps(ymm1, tv,_mm256_load_ps((const float*)(dptr+1)));
         ymm2 =_mm256_macc_ps(ymm2, tv,_mm256_load_ps((const float*)(dptr+2)));
         ymm3 =_mm256_macc_ps(ymm3, tv,_mm256_load_ps((const float*)(dptr+3)));
         ymm4 =_mm256_macc_ps(ymm4, tv,_mm256_load_ps((const float*)(dptr+4)));
         ymm5 =_mm256_macc_ps(ymm5, tv,_mm256_load_ps((const float*)(dptr+5)));
         ymm6 =_mm256_macc_ps(ymm6, tv,_mm256_load_ps((const float*)(dptr+6)));
         ymm7 =_mm256_macc_ps(ymm7, tv,_mm256_load_ps((const float*)(dptr+7)));
