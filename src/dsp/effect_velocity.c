...
static aaxEffect
_aaxVelocityEffectCreate(aaxConfig config, enum aaxEffectType type)
{
...
static int
_aaxVelocityEffectDestroy(aaxEffect f)
{
   int rv = AAX_FALSE;
...
static aaxEffect
_aaxVelocityEffectSetState(aaxEffect e, int state)
{
